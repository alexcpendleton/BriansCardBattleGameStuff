...
GoogleUrl = (function() {
    function GoogleUrl(sourceIdentifier, access_token) {
    ...
    this.jsonCellsUrl = "https://spreadsheets.google.com/feeds/cells/" + this.key + "/od6/private/basic?alt=json-in-script&access_token=" + access_token;
    this.jsonListUrl = "https://spreadsheets.google.com/feeds/list/" + this.key + "/od6/private/basic?alt=json-in-script&access_token=" + access_token;
    this.jsonUrl = this.jsonCellsUrl;
  }
  return GoogleUrl;
})();
GoogleSpreadsheet = (function() {
  function GoogleSpreadsheet(access_token) {
  ...
  GoogleSpreadsheet.prototype.url = function(url) {
    return this.googleUrl(new GoogleUrl(url, this.access_token));
  };
